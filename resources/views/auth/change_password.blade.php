            ...
            <div class="card-body">
              <form action="{{ route('update_password', $user->id) }}" method="POST">
                ...
                <div class="mb-3 mt-3 row d-flex">
                  ...
                  <div class="col-sm-8"> 
                    <input type="password" class="form-control" id="currentPw" name="currentPw" value="{{old('currentPw')}}"/>
                    @error('currentPw')
                ...
                <div class="mb-3 row d-flex">
                  ...
                  <div class="col-sm-8">
                    <input type="password" class="form-control" id="newPw" name="newPw" value="{{ old('newPw') }}"/>
                    @error('newPw')
                            <span class="text-danger">{{ $message }}</span>
                    @enderror
                  </div>
