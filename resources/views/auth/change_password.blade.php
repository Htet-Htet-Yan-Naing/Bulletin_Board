...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <div class="mb-3 mt-5 row d-flex">
      ...
      <div class="col-sm-8"> <input type="password" class="form-control" id="current-pw" name="current-pw"></div>
    </div>

  <!-- New password -->
  <div class="mb-3 row d-flex">
      <label for="new-pw" class="control-label col-sm-4">New Password:</label>
      <div class="col-sm-8"><input type="password" class="form-control" id="new-pw" name="new-pw"></div>
    </div>

  <!-- New confirm password -->
  <div class="mb-3 row d-flex">
      <label for="new-pw" class="control-label col-sm-4">New confirm Password:</label>
      <div class="col-sm-8"><input type="password" class="form-control" id="new-pw" name="new-confirm-pw"></div>
  </div>
